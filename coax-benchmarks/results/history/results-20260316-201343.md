...
|----------|--------|-------|--------|--------|
| Secrets | True Positive Rate | 00/12 | >90% | ⚠️ Review |
| Secrets | False Positive Rate | 0/11 | <5% | ✅ Pass |
| Secrets | Precision | Calculated below | >95% | - |
| Encoded | Detection Rate | 00/3 | >80% | - |
| Unicode | Bidi Coverage | 00/5 | 5/5 | - |
| Unicode | Homoglyph Coverage | 00/5 | 5/5 | - |
| Unicode | Invisible Chars | 00/5 | 5/5 | - |
